...
The main findings of the code can be found at the post available [here](https://medium.com/data-exploration-on-black-friday-dataset-from/this-blog-post-is-about-some-exploration-questions-on-black-friday-dataset-from-kaggle-7f27cfdedd5f).
